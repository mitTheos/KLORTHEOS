...
-  For wired builds I would go with RP3040 Pro Micro boards as it seems very compatible with QMK and much more powerful compared with ATMega32U4 MCU wich is a bit outdated now, but it offers the most support by far. QMK is very good IMHO apart from not having proper wireless options which is a real bummer...
